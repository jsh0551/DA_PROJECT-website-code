...
const qnaList = [
    ...
    {q : '4_2. 밥은 맛있는 걸로 먹어야지.<br>메뉴 중에서 먹고싶은 음식의 갯수는?<br>※메뉴 : 소고기,돼지고기,닭고기,양고기,치즈,초콜렛',
    a : [
        {
            answer : '4개 이상',
            score : 0.0
...
const resultList = [
    ...
    best_text : '지구를 위해 세탁 횟수를 줄여요! 안녕, 세탁으로 지구를 구하는 <span style="color:#3A66DF;font-weight: bold;">라퓨</span>라고 해!<br><br>'
    ...
    {worst : 'elec_high',
    best : 'elec_low',
    worst_text : '아. 반갑다. 나는. 전기를 좋아하는. 전기 보안관 <span style="color:#DF6D5A;font-weight: bold;">일렉토</span>다.<br><br>'
    +'이메일을 보관할 때 이산화탄소가 배출된다고 하던데, 당신 삭제 안 한 걸 나 안다.  안 쓰는 코드는 바로 뽑고, 사용하지 않는 컴퓨터는 절전 모드로 하도록. 그럼 내 사랑을 받을지도.<br><br>'
    +'전기 많이 나오니 이만 줄이지. 빠이.',
    best_text : '잠깐! 여기를 통과하려면 전기 사용량을 줄여야 한다.<br><br>'
    +'너는 누구냐! 보아하니 나 <span style="color:#3A66DF;font-weight: bold;">오펠</span>처럼 전기 사용을 줄이기 위해 노력하는 인간인 것 같군.<br><br>'
    +'넌 알고 있겠지.<br><br>'
    +'컴퓨터를 사용하지 않을 땐 절전 모드로 변경하고 이메일은 주기적으로 삭제해야 한다는 것을! 카톡으로 사진이나 영상을 다시 보내고 싶다면, 공유 버튼을 눌러서 보내야 에너지 사용량을 줄일 수 있다는 건 너를 위한 팁이다.<br><br>'
    +'전기 줄여야 하는데 얘기가 길어졌군. 넌 잘 하고 있으니 그만 가야겠어! 그럼 이만.'},
    {worst : 'coffee_high',
    best : 'coffee_low',
    ...
    {worst : 'deli_high',
    best : 'deli_low',
    worst_text : '안녕하세요, 오늘도 주문하셨네요? 저는 배달하는 <span style="color:#DF6D5A;font-weight: bold;">델리버</span>라고 해요. 저희 자주 뵙죠?<br><br>'
    +'주 3회 배달 음식을 시키면 연간 52.88kg 만큼의 이산화탄소가 배출된다고 하던데, 여러분 몸무게만큼 나오네요!<br><br>'
    +'이산화탄소도 줄이고 건강도 챙길 겸 저희 거리를 좀 두는 건 어떨까요? 그럼 주문하신 \'지구의 건강\' 두고 갈게요, 행복한 하루 되세요!',
